...
<script>
    ...
    function rowEditOperation(row) {
        ...
        $('#client_name_edit').val(row.name);
        $('#client_sex_edit').val(row.sex);
        $('#client_phone_edit').val(row.phone);
        $('#client_address_edit').val(row.address);
    }
        ...
        <div class="row" style="margin-top: 25px">
            <div class="col-md-5">
                <button class="btn btn-sm btn-default" id="add_goods">
                    <span class="glyphicon glyphicon-plus"></span> <span>添加客户信息</span>
                </button>
            </div>
                    ...
                    <div class="col-md-8 col-sm-8">
                        <form class="form-horizontal" role="form" id="goods_form"
                            ...
                            <div class="form-group">
                                <label for="" class="control-label col-md-4 col-sm-4"> <span>客户姓名：</span>
                                </label>
                                <div class="col-md-8 col-sm-8">
                                    <input type="text" class="form-control" id="client_name"
                                           name="goods_name" placeholder="客户姓名">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="control-label col-md-4 col-sm-4"> <span>客户性别：</span>
                                </label>
                                <div class="col-md-8 col-sm-8">
                                    <input type="text" class="form-control" id="client_sex"
                                           name="goods_type" placeholder="客户性别">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <input type="text" class="form-control" id="client_phone"
                                           name="goods_type" placeholder="联系电话">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <input type="text" class="form-control" id="client_address"
                                           name="goods_type" placeholder="地址">
                                </div>
                            </div>
                            <%--<div class="form-group">--%>
                    ...
                    <div class="col-md-8 col-sm-8">
                        <form class="form-horizontal" role="form" id="goods_form_edit"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <input type="text" class="form-control" id="client_sex_edit"
                                           name="goods_type" placeholder="客户性别">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <input type="text" class="form-control" id="client_phone_edit"
                                           name="goods_type" placeholder="联系电话">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <input type="text" class="form-control" id="client_address_edit"
                                           name="goods_type" placeholder="地址">
                                </div>
                            </div>
                        </form>
